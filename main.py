...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("👋 Welcome to Bit28! Ask me anything about Bit28, Investment/PAMM setup, or agent functionality and registration. ⚠️ Trading involves risk. Not financial advice.")
